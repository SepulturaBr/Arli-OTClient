...
SOUNDS = {
	-- Lavender town
	{fromPos = {x=1191, y=1039, z=7}, toPos = {x=1289, y=1078, z=7}, sound = "lavender.ogg"},
	-- Cerulean
	{fromPos = {x=1002, y=844,z =7}, toPos = {x=1101, y=944, z=7}, priority = 2, sound="cidade 1.ogg"},
	...
	{fromPos = {x=1056, y=1051, z=7}, toPos = {x=1059, y=1054, z=7}, priority = 2, sound="cidade 2.ogg"},
        {fromPos = {x=1050, y=1042, z=7}, toPos = {x=1055, y=1053, z=7}, priority = 2, sound="cidade 2.ogg"},
		...
		-- Batalha pvp
		{fromPos = {x=926, y=986, z=13}, toPos = {x=1020, y=1040, z=13}, priority = 1, sound="batalha.ogg"},
		-- Arena de duelos
